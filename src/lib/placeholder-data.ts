...
export const placeholderArticles: Article[] = [
  ...
  },
  {
    ...
    content: {
      ...
      gu: 'જાહેરાત પછી ટેક જગતમાં ઉત્સાહ છે. ક્વોન્ટમકોર ચિપ નવીન આર્કિટેક્ચરનો ઉપયોગ કરે છે જે સ્વાયત્ત વાહનોથી લઈને અદ્યતન તબીબી નિદાન સુધીની દરેક વસ્તુને શક્તિ આપી શકે છે. કંપની વર્ષના અંત સુધીમાં ડેવલપર કિટ्स બહાર પાડવાની યોજના ધરાવે છે.',
    },
    author: 'Priya Patel',
    category: 'Technology',
